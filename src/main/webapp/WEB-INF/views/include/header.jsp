							...
							<ul
								...
								<se:authorize
									...
									<li class="nav-item dropdown" id="alram"><a href="#"
										class="nav-link" id="supportDropdown"> <img
											src="${pageContext.request.contextPath}/assets/img/brand/ALARM.svg">
									</a> <!-- 드랍 박스 -->
									...
									<li class="nav-item dropdown"><a href="#" class="nav-link"
										id="info"> ${sessionScope.nickname}님 <span
											class="fas fa-angle-down nav-link-arrow ms-1"></span>
									</a> <!-- 드랍 박스 -->
										<div class="user_info" style="display: none">
											<div class="mypage">
												...
												<a
													href="${pageContext.request.contextPath}/mypage/mypageCheck">마이페이지</a>
											...
											<div class="Nav_Drop_A" id="test">
												알림
												<!-- <a href="">지원 내역</a> -->
											</div>
											<div class="Nav_Drop_A">
												<a href="${pageContext.request.contextPath}/project/create">프로젝트
													생성하기</a>
											</div>
